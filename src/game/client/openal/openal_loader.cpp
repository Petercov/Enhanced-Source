...
void COpenALLoader::Register( IOpenALLoaderExt *extension, const char *fileType )
{
...
void COpenALLoader::Deregister( IOpenALLoaderExt *extension, const char *fileType )
{
